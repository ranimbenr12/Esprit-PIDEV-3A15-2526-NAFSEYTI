...
//import tn.esprit.nafseyti.view.contenu.PsyContenu;
...
public class ListeFichesConsultationController implements Initializable {
    ...
    /*@FXML
    private void handleBtnContenu() {
        try {
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("/fxmlcontenu/PsyContenu.fxml"));
            Parent root = loader.load();

            PsyContenu controller = loader.getController();
            controller.setPsychologueId(psychologueId);
    ...
    //hethy tarjaa acceuil
    @FXML
    private void handleBtnAccueil() {
        try {
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("/fxmlPsychologue/AccueilPsychologue.fxml"));
            Parent root = loader.load();

            // Adapter selon le nom de ton contrôleur d'accueil
            PsychologueInterfaceController ctrl = loader.getController();
