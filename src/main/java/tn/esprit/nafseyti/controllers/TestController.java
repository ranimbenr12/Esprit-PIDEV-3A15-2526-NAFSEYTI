...
public class TestController implements Initializable {
    ...
    private void toggleFormulaire() {
        ...
        if (isFormVisible) {
            ...
            formulaireCard.setOpacity(0);
            formulaireCard.setTranslateY(-formulaireCard.getHeight());

            TranslateTransition slide = new TranslateTransition(Duration.millis(300), formulaireCard);
            slide.setFromY(-formulaireCard.getHeight());
            slide.setToY(0);

            FadeTransition fade = new FadeTransition(Duration.millis(300), formulaireCard);
            fade.setFromValue(0);
            fade.setToValue(1);
            ...
            TranslateTransition slide = new TranslateTransition(Duration.millis(200), formulaireCard);
            slide.setToY(-formulaireCard.getHeight());

            FadeTransition fade = new FadeTransition(Duration.millis(200), formulaireCard);
            fade.setToValue(0);
            ...
            pt.setOnFinished(e -> {
                ...
                formulaireCard.setTranslateY(0); // reset pour le prochain toggle
            });
            pt.play();
