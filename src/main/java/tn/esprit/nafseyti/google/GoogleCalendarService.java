...
public class GoogleCalendarService {
    ...
    public static void forceReAuthenticate() throws Exception {
        NetHttpTransport transport = GoogleNetHttpTransport.newTrustedTransport();
        GoogleAuthorizationCodeFlow authFlow = getFlow(transport);
        authFlow.getCredentialDataStore().delete("user");
        calendarService = null;
        flow = null;
        System.out.println("🔄 Token supprimé — re-authentification requise");
    }
    ...
    public static String createEvent(String titre,
                                     ...
                                     LocalTime fin,
                                     String typeSeance,
                                     String medecinNom) throws Exception {
        Event event = new Event()
                .setSummary(titre)
                .setDescription(
                        "👨‍⚕️ Médecin : " + medecinNom + "\n" +
