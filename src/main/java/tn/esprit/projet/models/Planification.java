...
public class Planification {
    ...
    public boolean equals(Object o) {
        ...
        return idPlanification == that.idPlanification && idEvent == that.idEvent && Objects.equals(description, that.description) && Objects.equals(duree, that.duree) && Objects.equals(event, that.event);
    }

    @Override
    public int hashCode() {
        return Objects.hash(idPlanification, idEvent, description, duree, event);
    }
}
