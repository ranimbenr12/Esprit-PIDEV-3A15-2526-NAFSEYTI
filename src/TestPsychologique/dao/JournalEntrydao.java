...
public class JournalEntrydao {
     ...
     */
    public JournalEntry getEntryByDate(int userId, java.sql.Date date) {
     ...
     */
    public List<JournalEntry> getEntriesByPeriod(int userId, java.sql.Date startDate, java.sql.Date endDate) {
        List<JournalEntry> entries = new ArrayList<>();
     ...
     */
    public Map<String, Integer> getHumeurStatistics(int userId, java.sql.Date startDate, java.sql.Date endDate) {
     ...
     */
    public double getAverageEnergie(int userId, java.sql.Date startDate, java.sql.Date endDate) {
