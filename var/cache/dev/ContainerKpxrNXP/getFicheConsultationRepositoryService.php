 ...
 */
class getFicheConsultationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FicheConsultationRepository' shared autowired service.
     *
     * @return \App\Repository\FicheConsultationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FicheConsultationRepository.php';

        return $container->privates['App\\Repository\\FicheConsultationRepository'] = new \App\Repository\FicheConsultationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
