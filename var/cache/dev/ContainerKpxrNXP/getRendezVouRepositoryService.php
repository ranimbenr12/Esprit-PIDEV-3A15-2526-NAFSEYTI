 ...
 */
class getRendezVouRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RendezVouRepository' shared autowired service.
     *
     * @return \App\Repository\RendezVouRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RendezVouRepository.php';

        return $container->privates['App\\Repository\\RendezVouRepository'] = new \App\Repository\RendezVouRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
