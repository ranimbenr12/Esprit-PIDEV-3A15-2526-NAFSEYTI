 ...
 */
class getCongeMaladieRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CongeMaladieRepository' shared autowired service.
     *
     * @return \App\Repository\CongeMaladieRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CongeMaladieRepository.php';

        return $container->privates['App\\Repository\\CongeMaladieRepository'] = new \App\Repository\CongeMaladieRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
