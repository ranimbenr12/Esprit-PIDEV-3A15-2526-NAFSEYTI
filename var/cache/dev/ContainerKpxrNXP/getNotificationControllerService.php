...
class getNotificationControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['App\\Controller\\Admin\\NotificationController'] = $instance = new \App\Controller\Admin\NotificationController();

        $instance->setContainer(($container->privates['.service_locator.rz2KodV'] ?? $container->load('get_ServiceLocator_Rz2KodVService'))->withContext('App\\Controller\\Admin\\NotificationController', $container));
