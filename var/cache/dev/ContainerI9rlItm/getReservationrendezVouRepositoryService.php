 ...
 */
class getReservationrendezVouRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReservationrendezVouRepository' shared autowired service.
     *
     * @return \App\Repository\ReservationrendezVouRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReservationrendezVouRepository.php';

        return $container->privates['App\\Repository\\ReservationrendezVouRepository'] = new \App\Repository\ReservationrendezVouRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
