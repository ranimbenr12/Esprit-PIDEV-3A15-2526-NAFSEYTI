 ...
 */
class getNotificationrendezVouRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\NotificationrendezVouRepository' shared autowired service.
     *
     * @return \App\Repository\NotificationrendezVouRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NotificationrendezVouRepository.php';

        return $container->privates['App\\Repository\\NotificationrendezVouRepository'] = new \App\Repository\NotificationrendezVouRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
